...
/// </summary>
public record SearchUsersQuery : PaginationParams, IRequest<PaginatedResponse<UserResult>>
{
    /// <summary>
    ...
    public SearchUsersQuery(int page = 1, int pageSize = 10, string? orderBy = null)
